...
1. Review "Presentations Guidelines for Posters"
    - <https://ur.umbc.edu/urcad/resources/posters-guidelines>
1. Skim three posters from among the following
    - C-MOOR Posters -- <https://help.c-moor.org/c/look-at-this/8>
    - UW-Madison Posters -- <https://introbio.integrativebiology.wisc.edu/i-p-posters>
    - Example PacBio Poster -- <https://www.pacb.com/wp-content/uploads/PAG-Portik.pdf>
1. Pick one poster and address the following points.
...
1. Post your answers by replying to the “Project Work: Scientific Posters” topic in the Discussion Forum
...
- [Google Doc](https://docs.google.com/document/d/1JxcGUh8yX8Kr186_akCe1X7nZXNqu9Ei)
...
This activity introduces agentic AI, automated systems that can plan, create, and execute multi-step tasks. 
As these systems require a computer to install and run programs, we will use Zo Computer which provides a personal computer in the cloud equipped with an AI agent.
You will work through two real-world tasks: building a professional website and orchestrating data analysis through natural language commands.

Getting comfortable with agentic AI is becoming an important professional skill across virtually every field.
Employers increasingly recruit workers who can leverage AI to automate workflows, accelerate research, and focus on higher-level creative and strategic work.
Learning to effectively communicate with and orchestrate AI agents will set you apart in an increasingly AI-driven workplace.

### Learning Objectives

1. Set up a personal AI agent
2. Create a professional website by prompting an AI agent
3. Connect an external service to an AI agent using an API key
4. Orchestrate a genome analysis workflow using natural language
5. Evaluate and refine AI outputs through iterative prompting

### Activity 1 - Create an academic website

*Estimated time: 20 min*

#### Instructions

1. Create a free account at Zo Computer
    a. Go to <https://zocomputer.com> and click Sign Up
    a. Enter your preferred email address and create a password
    a. Check your inbox for a verification email and click the confirmation link
    a. Complete your profile (handle, display name)
    a. Your Zo Computer will be ready at https://&lt;your-handle&gt;.zo.computer

#### Part 1 - Create a sample website

#### Instructions

1. Use the prompt below to create an example website using the sample resume and picture links provided

```
Prompt: 
Create an academic website similar to https://demostudent.faculty.bio using resume https://careercenter.ucdavis.edu/sites/g/files/dgvnsk15461/files/media/documents/HBS-Laboratory-Research.pdf, - including all sections - and picture (silhouette placeholder) https://drive.google.com/file/d/1zXVWjLy1vm78v8nzmTYNFFZ_kQxMB1dR
```

#### Questions

| 1. Paste the link to the sample website you created below |
| :--------- | 
| <br>       |

#### Part 2 - Customize your website

#### Instructions

1. Upload to Zo Files a resume and picture of yourself or from the samples below
    - Additional resumes -- <https://careercenter.ucdavis.edu/resumes-and-materials/resumes/resume-cv-samples>
    - Photo -- <https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Mark_Rober-_Close.png/250px-Mark_Rober-_Close.png>
2. Personalize your website by referring to the two files and the following prompt

```
Prompt: 
Replace sample website with my resume and photo in Files.
```

3. Add additional information to your website such as
    - Capstone poster you uploaded to <https://help.c-moor.org>
    - Short bio (2-3 sentences) and research description
    - Links to social media profiles e.g. LinkedIn

#### Questions

1. What additional prompts did you use?

| Your additional prompts: |
| :--------- | 
| Prompt 1: |
| Prompt 2: |
| Prompt 3: |
...
2. Did your agent do what you asked it to do? If not, what did it get wrong and what prompts did you use to fix it ?

| Your comments: |
| :--------- | 
| <br>       |

### Activity 2 - Use natural language to orchestrate Galaxy

*Estimated time: 20 min*

#### Instructions

1. Set up Zo with access to your Galaxy account
    a. Get Galaxy API key -- Log into Galaxy > Preferences (under your username in upper right corner) > Manage Galaxy API Key > Copy key
    a. Store key in Zo -- Go to Settings (lower left corner) > Advanced > Secrets and adding a Key named GALAXY_API_KEY and paste key under Value and click +Add

2. Use the following prompt to create a Python script that directs Galaxy (through BioBlend) to analyze a small dataset (an imaginary Staphylococcus aureus bacterium with a miniature genome) using the FastQC tool. 

```
Prompt: 
Use Galaxy https://usegalaxy.org](https://usegalaxy.org) to analyze https://zenodo.org/record/582600/files/mutant_R1.fastq using the FastQC tool. Orchestrate this analysis using BioBlend. Use stored GALAXY_API_KEY.
```

#### Questions

1. Provide Galaxy Link to FastQC Analysis executed by your agent

| Provide Your Galaxy Link to FastQC Analysis: |
| :--------- | 
| <br>       |

2. Prompt your agent to perform genome assembly in Galaxy from SHORT reads, then provide Galaxy link to analysis. 
    - Note 1: The reads are **not metagenomic reads**, but come from a single mock organism - so don’t use a metagenomic assembler, but a standard assembler.
    - Note 2: **Do NOT use Flye tool** designed for long reads, instead google or ask your agent to check which short read assemblers are available for short reads on Galaxy.

| 2A. Include your prompt(s) below: |
| :--------- | 
| <br>       |

| 2B. Provide link to your Galaxy assembly analysis: |
| :--------- | 
| <br>       |


| 2C. Ask your agent to ‘List all of my prompts in this conversation’ and paste them below: |
| :--------- | 
| <br>       |
...
- [Google Doc](https://docs.google.com/document/d/1CxtUe6_F3n8OGYDmr7vqjVsizTuCPBzx)
- More example academic website at <https://www.faculty.bio/page/example-academic-websites>
