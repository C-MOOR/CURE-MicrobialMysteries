...
<img src="finding-AMRs_files/figure-html//1hYKF7Ss3vJ8rrUIH7ByNh1BUlRa2fhsJhq8MXzEowCc_g344ad28629a_0_440.png" alt="Image test" width="100%" style="display: block; margin: auto;" />
...
<img src="finding-AMRs_files/figure-html//1hYKF7Ss3vJ8rrUIH7ByNh1BUlRa2fhsJhq8MXzEowCc_g344ad28629a_0_345.png" alt="Image test" width="100%" style="display: block; margin: auto;" />

## Lecture: Finding AMRs

<img src="finding-AMRs_files/figure-html//165OHha9IYOctuyzg1CG0LwGxNnbC85JyJfMZT6xnYHw_g35f391192_00.png" alt="Image test" width="100%" style="display: block; margin: auto;" />
...
<img src="finding-AMRs_files/figure-html//1hYKF7Ss3vJ8rrUIH7ByNh1BUlRa2fhsJhq8MXzEowCc_g344ad28629a_0_459.png" alt="Image test" width="100%" style="display: block; margin: auto;" />
...
<img src="finding-AMRs_files/figure-html//1hYKF7Ss3vJ8rrUIH7ByNh1BUlRa2fhsJhq8MXzEowCc_g33689793048_0_0.png" alt="Image test" width="100%" style="display: block; margin: auto;" />

<img src="finding-AMRs_files/figure-html//1hYKF7Ss3vJ8rrUIH7ByNh1BUlRa2fhsJhq8MXzEowCc_g33689793048_0_10.png" alt="Image test" width="100%" style="display: block; margin: auto;" />

2. View Flye results - Explore Flye output files and answer questions below.

<img src="finding-AMRs_files/figure-html//1hYKF7Ss3vJ8rrUIH7ByNh1BUlRa2fhsJhq8MXzEowCc_g33689793048_0_21.png" alt="Image test" width="100%" style="display: block; margin: auto;" />
...
2. Pair up into groups (10 min).
    ...
    - Summarize -- Identify best answer and add to slidedeck
        - [docs.google.com/presentation/d/1cxc5olCzLtWCbAxoVaMqNXlp_aE4rU5rSnP-jCDaFg0](https://docs.google.com/presentation/d/1cxc5olCzLtWCbAxoVaMqNXlp_aE4rU5rSnP-jCDaFg0)
...
- [Google Doc](https://docs.google.com/document/d/1JqQPF1eFbri2cg89S3tdgEB4sp0dnJWZ)
...
1. Visualize the contigs with **Bandage** tool
1. Find AMRs in contig assemblies using **ABRicate** tool
1. Bin contigs into larger MAGS using **MetaBAT2** tool 
1. Learn about **GTDB-Tk** taxonomy classifier tool
...
1. Run Flye in Galaxy on adapter-trimmed (with Porechop tool) and quality filtered (with fastp tool) nanopore soil subset [nanopore-soil-subset-filtered](https://usegalaxy.org/u/valerie-g/h/nanopore-soil-subset-filtered-1) to de novo assemble soil microbial genomes.  
    ...
    a. Name your new history **Finding soil AMRs**.
    a. Run **Flye** tool to assess sequence quality using the following **Tool Parameters**.
        ...
        - Under **Perform metagenomic assembly**: select `Yes`.
        - Under **Generate a log file**: select `Yes`.
1. Explore Flye output **assembly info** file which is sorted by length (in base pairs, bp) of the contig (high to low). 
...
**Note:** It is NOT because of the difference in the size of the sequencing file.
    - Think about possible differences in the microbial diversity of the two samples.
...
1. Run **ABRicate** tool in Galaxy using Flye consensus as input using the following **Tool Parameters**:
    - Under **Input Reads**: select your `Flye: consensus` output in FASTA format.
    - IMPORTANT: Under **Advanced Options**: select `NCBI Bacterial Antimicrobial Resistance Reference Gene Database` as your database option; the default ‘resfinder’ may not work well.
1. Explore **ABRicate report** file.
...
1. Run **MetaBAT2** tool in Galaxy using `Flye consensus` as input using the **following Tool Parameters**:
...
- [Google Doc](https://docs.google.com/document/d/1G3F0NR2IfUTuag0WIdE-ZsyBiNTPVcMb)
...
1. Open the “Finding AMRs Presentation” slidedeck
    - [docs.google.com/presentation/d/1cR-TaRfXbax1PEl-wX-JYD9eOJBekfkXsasjdnmxzWg](https://docs.google.com/presentation/d/1cR-TaRfXbax1PEl-wX-JYD9eOJBekfkXsasjdnmxzWg)
2. Create two slides to present your findings
    - Summarize the metagenome assembly statistics for the BioDIGS soil sample 
    - Report on one of the AMR genes you found
...
4. Present to the class (2 min each group)

#### Footnotes

**Resources**

- [Google Doc](https://docs.google.com/document/d/1RYX5wfC3srK8w9p10y_ny_a8zrGZzwGK)
