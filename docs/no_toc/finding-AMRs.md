...
2. Create two slides to present your findings
    - Summarize the metagenome assembly statistics for the BioDIGS soil sample (Results)
    - Report on one of the AMR genes you found (Discussion)
    - Describe GTDB and the associated GTDB-Tk software toolkit (Methods)
