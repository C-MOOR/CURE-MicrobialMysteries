...
<img src="project-work_files/figure-html//1hYKF7Ss3vJ8rrUIH7ByNh1BUlRa2fhsJhq8MXzEowCc_g370690c0d46_0_46.png" alt="Image test" width="100%" style="display: block; margin: auto;" />
...
<img src="project-work_files/figure-html//1j1u4frdYt18nVmjMs6ZPRoP1KfXxognVUYG-2itH6kE_g35f391192_00.png" alt="Image test" width="100%" style="display: block; margin: auto;" />
...
3. Import a **long-read** SRA dataset you would like to analyze for your research project
...
|1. Share your Galaxy history with the SRR29980924.fastq data you downloaded with Faster Download and Extract Reads in FASTQ tool.|
|:--------|
| Galaxy history Link: |
...
Using **GTDB-Tk Classify genomes** tool, classify the nanopore-soil MAGs you obtained  from **MetaBAT2** binning of contigs during Project: Finding AMRs, Activity 4. 

1. Go to your Galaxy history for Project: Finding AMRs, Activity 4
1. In your history, use the output of MetaBAT2 binning, as input for classification with GTDB-Tk.
    - Note, `MetaBAT2 bins are a collection`, so try using **Dataset collection** (instead of multiple individual files) as input. 
...
### Activity 3 – Import a long-read SRA dataset of interest for your research project
...
Note: You **must** start with a long-read SRA dataset.  Check that the Instrument is one from PacBio or Oxford Nanopore e.g.

- RS II, Sequel II, Revio
...
|:--------|
|Organism:   |
| Instrument: <must be long-read, see note above> |
|Strategy: |
| Run: |
...
- [Google Doc](https://docs.google.com/document/d/15YJnP2dW0YQDIi-NBARGRjzLG621sMMM)
...
<img src="project-work_files/figure-html//1VxwSmAY8BUs3EfVcxPm3I8kNYJWjVqoHJrGOX3X3sog_g35f391192_00.png" alt="Image test" width="100%" style="display: block; margin: auto;" />
