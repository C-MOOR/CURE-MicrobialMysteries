...
The [C-MOOR](https://www.c-moor.org){target="_blank"} project works to create early research experiences through curricula like our [miniCUREs](https://science.c-moor.org/miniCURE-RNA-seq/) that help integrate data science and hands-on research into lower level coursework. 


C-MOOR is a project to invite students to join the data science revolution and be part of the next generation of data scientists.  
This project provides online materials to help students and instructors incorporate authentic research experiences in lower division courses. To learn more about its presence at Clovis Community College, visit [https://www.cloviscollege.edu/alumni-and-community/c-moor/c-moor.html](https://www.cloviscollege.edu/alumni-and-community/c-moor/c-moor.html)

### C-MOOR Learning goals {- .unlisted}

1. Engage with and explore real and current scientific data
1. Gain genomics data analysis skills
1. Synthesize findings from scientific literature
1. Summarize findings and discuss results with your peers
1. Collaborate with peers on a data exploration and engage in peer review
1. Recognize the interdisciplinary nature of biological sciences

### CURE Microbial Mysteries Overview {-}

This Course-based Undergraduate Research Experience (CURE) focuses on the world of microbes. Microorganisms surround us, from the microbes in soil to the bacteria in our digestive systems.  C-MOOR CURE Microbial Mysteries introduces computational tools through Galaxy [https://usegalaxy.org](https://usegalaxy.org) and SciServer [https://sciserver.org](https://sciserver.org) platforms to analyze metagenomic datasets and conduct independent research projects.  Dig into soil metagenomics datasets generated by the GDSCN BioDIGS consortium [http://biodigs.gdscn.org](http://biodigs.gdscn.org) and study the soil biodiversity and ecological factors that impact human health and ecological concerns or explore publicly accessible human gut metagenomics datasets [https://www.ncbi.nlm.nih.gov/bioproject](https://www.ncbi.nlm.nih.gov/bioproject) and study how our microbiomes are shaped by our diet, medications, and genetics.  

<img src="01-introduction_files/figure-html//1hYKF7Ss3vJ8rrUIH7ByNh1BUlRa2fhsJhq8MXzEowCc_g344ad28629a_0_188.png" alt="Image test" width="100%" style="display: block; margin: auto;" />

### An Introduction to Data Science {- .unlisted}

Data Science is an evolving career path for individuals (data scientists) in fields that need to manipulate large amounts of data. The job of a Data Scientist was called by the Harvard Business Review [“the sexiest job of the 21st century”](https://hbr.org/2012/10/data-scientist-the-sexiest-job-of-the-21st-century) and defined as “a professional with the training and curiosity to make discoveries in the world of big data.” Indeed, data Scientists are individuals with a curiosity to look through data, identify patterns and develop testable hypotheses. In Biological Sciences, data scientists dig through data to answer questions about health, disease, evolution, ecology, drug development, and much more. At C-MOOR, we focus on genomic data science that specializes in analyzing and interpreting genomic sequencing data. 


## Welcome to Your Genomics Adventure

[Slides: Welcome to Your Genomics Adventure!](https://docs.google.com/presentation/d/1-D7nd_QGZ9dlKgxSaOUO89yO4du4la9xbPrQh0fkE8s)
...
1. C-MOOR Academy Discussion Forum – [https://help.c-moor.org](https://help.c-moor.org)
    - Submit your username using [this form](https://docs.google.com/forms/d/e/1FAIpQLScxJhEZ3EJGa53BMd0ce3Q3JPXyekbLTTV4ASF80bNECz26Ww/viewform)
...
- [Google Doc](https://docs.google.com/document/d/1ONujIxBJS1IlXZ7yjiKqAzjoc1IgBRpg)
...
[Slides: The Scientic Process](https://docs.google.com/presentation/d/1PraeATNael3C01yU3tgk4W1Uqy0O3reb1AGivt3ib9M)
...
4. Click on the private category that belongs to your class e.g. <mark style="background-color: yellow">Spring 2026</mark>. In this private channel, we will add a “New Topic” in which you can introduce yourself to the class.
...
1. Click on the “<mark style="background-color: yellow">Breakroom</mark>” Category. This is an informal category where we can chat about non-science related topics.
1. Look for a topic called “<mark style="background-color: yellow">Quirky or Silly Talents</mark>” Click on the topic.
...
- [Google Doc](https://docs.google.com/document/d/1dibSiZYghss_ZNhCwu6ZOyttVvqx5lCV)
