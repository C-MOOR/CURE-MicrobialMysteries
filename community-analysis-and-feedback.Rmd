...
This lesson introduces Agentic AI — AI systems that can autonomously plan, reason, and execute multi-step tasks. 
You will gain hands-on experience using Zo Computer, a personal AI agent, to accomplish real-world tasks: building an academic website and orchestrating scientific data analysis through natural language commands.

Getting comfortable with agentic AI is becoming a valuable professional skill across virtually every field — employers increasingly value workers who can leverage AI to automate workflows, accelerate research, and focus on higher-level creative and strategic work. Learning to effectively communicate with and orchestrate AI agents will set you apart in an increasingly AI-driven workplace.

### Learning Objectives

1. Set up and navigate a personal AI agent workspace (Zo Computer)
2. Create a functional academic website by prompting an AI agent with context-aware instructions
3. Connect external services (Galaxy, file storage) to an AI agent via API key
4. Orchestrate complex scientific workflows — such as genome analysis — using only natural language
5. Evaluate and refine AI outputs through iterative prompting

#### Activity 1 - Create an academic website using Zo Computer

*Estimated time: 20 min*

#### Instructions

1. Create a free Zo account
    a. Go to zocomputer.com and click Sign Up
...
#### Part 1 - Create a sample academic website as prototype

#### Instructions

1. Use the prompt below to create a sample academic website using sample resume and picture links provided
...
| 1. Paste the link to the sample Zo website you created below |
| :--------- | 
| <br>       |

#### Part 2 - Personalize academic website by replacing sample content

#### Instructions

1. In Zo, personalize a sample academic website with your resume and your picture (or famous scientist’s) by modifying the prompt above to include your personalized information. 
    a. Upload your resume to Zo Files 
    a. Name your resume file ‘resume’
    a. Upload your photo to Zo Files
    a. Name your  photo file ‘photo’
    a. Provide  a prompt to build your personal website

```
Prompt: 
Replace sample website with my resume and photo attached in Files.
```

#### Questions

1. Provide link to personalized website below:

|Link to your personalized academic website: |
| :--------- | 
| <br>       |


2. Add additional information to your personal website and provide your promts below:

Additional information suggestions:
  - Your capstone poster you posted on [https://help.c-moor.org](https://help.c-moor.org)
  - A short bio (2-3 sentences) and research description
  - Any relevant links - e.g. your LinkedIn

For more information and sample resumes see **Resources** section of this document for more source materials related to academic websites
...
3. Did Zo do what you asked it to do? If not, what did it get wrong and what prompts did you use to fix it ?

| Your comments: |
| :--------- | 
| <br>       |

4. Provide a link to your updated personal academic website:


|Link to your UPDATED personalized academic website: |
| :--------- | 
| <br>       |


#### Activity 2 - Use natural language in Zo to orchestrate Galaxy

*Estimated time: 20 min*

#### Instructions

1. Setup Zo with access to your Galaxy account.
    a. **Get Galaxy API key** by logging into Galaxy > Preferences  (under your use name tab in upper right corner) > Manage Galaxy API Key >  Copy key
    a. **Store key in Zo** by going to Settings (lower left corner) > Advanced > Secrets and adding a Key named GALAXY_API_KEY and pasting key under Value and click +Add

2. **Use the following Prompt in Zo**, to instruct Galaxy to analyze a small dataset (an imaginary Staphylococcus aureus bacterium with a miniature genome)  using the FastQC tool. 
...
1. Provide Galaxy Link to FastQC Analysis executed by Zo:
...
2. Prompt Zo to perform genome assembly in Galaxy from SHORT reads, then provide galaxy link to analysis executed by Zo. 
  - Note 1: The reads are **not metagenomic reads**, but come from a single mock organism - so don’t need a metagenomic assembler, but a genomic assembler.
  - Note 2: **Do NOT use Flye tool** designed for long reads, instead google or ask Zo to check which short read assemblers are available for short reads on Galaxy.
...
| 2B. Provide your Galaxy Link to assembly analysis: |
| :--------- | 
| <br>       |


| 2C. Ask Zo to ‘List all of my prompts in this conversation’ and paste them below: |
| :--------- | 
| <br>       |
...
- Google Doc
- Relevant source materials for a personal website:
    - Resume and CV samples [https://careercenter.ucdavis.edu/resumes-and-materials/resumes/resume-cv-samples](https://careercenter.ucdavis.edu/resumes-and-materials/resumes/resume-cv-samples) such as "Laboratory Research" CV [https://careercenter.ucdavis.edu/sites/g/files/dgvnsk15461/files/media/documents/HBS-Laboratory-Research.pdf](https://careercenter.ucdavis.edu/sites/g/files/dgvnsk15461/files/media/documents/HBS-Laboratory-Research.pdf)
    - Photo from https://en.wikipedia.org/wiki/Mark_Rober
    - "Demo Student" example website at [https://www.faculty.bio/page/example-academic-websites](https://www.faculty.bio/page/example-academic-websites)
